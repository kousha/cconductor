...
3.  **Interaction Paths:**
    ...
    *   **PATH A: Direct Confirmation**
        ...
        3.  If "yes", establish this as the `target_intent` and proceed to Phase 2. If "no", ask the user: "I'm sorry, I misunderstood. Please describe the Track, Phase, or Task you would like to revert." Wait for their response before proceeding.
    ...
    *   **PATH B: Guided Selection Menu**
        ...
        2.  **Present a Unified Hierarchical Menu:** Ask the user: "I found multiple in-progress items (or recently completed items). Please choose which one to revert:"
            Present the identified items as a numbered list, grouped by Track in the description if possible. **CRITICAL:** Limit this to a maximum of 4 items.
            - Example: `1. **[Task] Update user model** — Track: track_20251208_user_profile`
            - Example: `2. **[Phase] Implement Backend** — Track: track_20251208_user_profile`
        ...
        3.  **Process User's Choice:**
            ...
            *   If the user wants something else not on the list, ask them to describe the target. Once identified, loop back to Path A for final confirmation.
...
2.  **Final Go/No-Go:** Ask the user: "Do you want to proceed with the drafted plan?"
    1. **Approve** — Proceed with the revert actions.
    2. **Revise** — I want to change the revert plan.
    Wait for their response.

3.  **Process User Choice:**
    - If "Approve", proceed to Phase 4.
    - If "Revise", ask the user: "Please describe the changes needed for the revert plan." Wait for their response before proceeding.
